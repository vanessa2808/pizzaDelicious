                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Add Recipe</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                            <div class="basic-login-inner">
                                                <h3>Add recipe</h3>
                                                <form action="admin/recipes/add_recipe" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleProductsType1">Pizza ingredients</label>
                                                        <select class="form-control" id="recipeTypeId" name="recipeTypeId">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <label>nameOfRecipes</label>
                                                        <input type="text" class="form-control" placeholder="Enter nameOfRecipes" name="nameOfRecipes" />
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">description</label>
                                                        <textarea type="text" class="ckeditor form-control" id="decription"
                                                                  placeholder="Enter decription" name="decription"></textarea>

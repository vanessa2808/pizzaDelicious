                                            ...
                                            <div class="basic-login-inner">
                                                ...
                                                <form action="admin/food/add_pizza" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleProductsType1"> bakery Types</label>
                                                        <select class="form-control" id="bakeryType_id" name="bakeryType_id">
                                                            <option value="0">--Choose ingredients type of pizza--</option>
                                                            @foreach($listBakeryTypes as $key => $bakeryTypes)
                                                                <option value="{{ $bakeryTypes->id }}">{{ $bakeryTypes->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
